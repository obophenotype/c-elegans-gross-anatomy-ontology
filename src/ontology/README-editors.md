...
To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/obophenotype/c-elegans-gross-anatomy-ontology) for details.
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/wbbt_terms.txt file
...
Note: the wbbt_terms.txt file may include 'starter' classes seeded from
 ...
 * https://github.com/obophenotype/c-elegans-gross-anatomy-ontology/releases
 * https://github.com/obophenotype/c-elegans-gross-anatomy-ontology/releases/new
...
Check the build status here: [![Build Status](https://travis-ci.org/obophenotype/c-elegans-gross-anatomy-ontology.svg?branch=master)](https://travis-ci.org/obophenotype/c-elegans-gross-anatomy-ontology)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/obophenotype](https://travis-ci.org/profile/obophenotype)
 2. click the "Sync account" button
 3. Click the tick symbol next to c-elegans-gross-anatomy-ontology
